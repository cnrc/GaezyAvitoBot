...
async def handle_message(message: types.Message):
    ...
    # Полный список исключений для команд и кнопок, которые обрабатываются другими роутерами
    excluded_texts = {
        # Команды
    ...
    if text in excluded_texts:
        print(f"🚨 MESSAGES HANDLER: Пропускаем сообщение '{text}' - обрабатывается другим роутером")
